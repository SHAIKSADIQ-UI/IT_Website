...
const CareersPage = () => {
  ...
  // NOTE: The `useNavigate` hook is kept for other links on the page, like the CTA button.
  const navigate = useNavigate();
  ...
  const jobOpenings = [
    {
      ...
      description:
        "We are looking for a skilled React Developer to join our frontend team and build amazing user experiences.",
      googleFormLink: "https://docs.google.com/forms/d/e/1FAIpQLSf6N_gntXhRf6V_oA3mbIbVm0AxLssWRzeiyA0PPc2fBsIVpg/viewform?usp=pp_url&entry.1551074796=Senior+React+Developer",
      requirements: [
        "3+ years of experience with React.js",
        "Strong knowledge of JavaScript, HTML5, CSS3",
        "Experience with Redux, Context API",
    ...
    },
    {
      ...
      description:
        "Join our design team to create beautiful and intuitive user interfaces that delight our clients.",
      googleFormLink: "https://docs.google.com/forms/d/e/1FAIpQLSf6N_gntXhRf6V_oA3mbIbVm0AxLssWRzeiyA0PPc2fBsIVpg/viewform?usp=pp_url&entry.1551074796=UI/UX+Designer",
      requirements: [
        "2+ years of UI/UX design experience",
        "Proficiency in Figma, Adobe XD, Sketch",
        "Strong portfolio showcasing design skills",
    ...
    },
    {
      ...
      description:
        "Build scalable backend systems and APIs that power our applications and serve millions of users.",
      googleFormLink: "https://docs.google.com/forms/d/e/1FAIpQLSf6N_gntXhRf6V_oA3mbIbVm0AxLssWRzeiyA0PPc2fBsIVpg/viewform?usp=pp_url&entry.1551074796=Node.js+Backend+Developer",
      requirements: [
        "2+ years of Node.js development",
        "Experience with Express.js framework",
        "Knowledge of MongoDB, PostgreSQL",
    ...
    },
    {
      ...
      description:
        "Drive our digital marketing efforts and help clients achieve their marketing goals through innovative strategies.",
      googleFormLink: "https://docs.google.com/forms/d/e/1FAIpQLSf6N_gntXhRf6V_oA3mbIbVm0AxLssWRzeiyA0PPc2fBsIVpg/viewform?usp=pp_url&entry.1551074796=Digital+Marketing+Specialist",
      requirements: [
        "1+ years of digital marketing experience",
        "Knowledge of SEO, SEM, social media marketing",
        "Experience with Google Ads, Facebook Ads",
    ...
    },
    {
      ...
      description:
        "Lead project teams and ensure successful delivery of client projects on time and within budget.",
      googleFormLink: "https://docs.google.com/forms/d/e/1FAIpQLSf6N_gntXhRf6V_oA3mbIbVm0AxLssWRzeiyA0PPc2fBsIVpg/viewform?usp=pp_url&entry.1551074796=Project+Manager",
      requirements: [
        "3+ years of project management experience",
        "PMP or Agile certification preferred",
        "Experience with project management tools",
  ...
  // ** MODIFIED FUNCTION **
  // This function now opens the provided URL in a new browser tab.
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <div className="flex flex-col sm:flex-row lg:flex-col gap-3 mt-6 lg:mt-0 lg:ml-8">
                    ...
                    <button
                      // ** MODIFIED onClick **
                      // This now passes the specific Google Form link for the job
