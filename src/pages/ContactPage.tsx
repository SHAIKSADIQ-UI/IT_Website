...
//             <div className="h-96 w-full">
//               <iframe 
//                 src="https://www.google.com/maps/place/Synnectify+Technologies/@16.5689109,80.6296022,209m/data=!3m2!1e3!4b1!4m6!3m5!1s0x3a35ef17f516222b:0x583445eb79c81cca!8m2!3d16.5689109!4d80.6296022!16s%2Fg%2F11yh1vmn49!5m1!1e4?entry=ttu&g_ep=EgoyMDI1MDgxMy4wIKXMDSoASAFQAw%3D%3D" 
//                 width="100%" 
//                 height="100%" 
//                 style={{ border: 0 }}
//                 allowFullScreen
  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Location',
      details: ['Telangana', 'Andhra Pradesh'],
      color: 'text-blue-600'
    },
    {
      icon: Phone,
      title: 'Phone',
      details: ['+919494669228'],
      color: 'text-blue-600'
    },
    {
      icon: Mail,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-200 rounded-xl overflow-hidden shadow-lg">
            <div className="h-96 w-full">
              ...
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15298.764426210086!2d80.61868305!3d16.5689109!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a35ef17f516222b%3A0x583445eb79c81cca!2sSynnectify%20Technologies!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
                width="100%" 
                height="100%" 
                style={{ border: 0 }}
                allowFullScreen
                ...
                referrerPolicy="no-referrer-when-downgrade"
                className="w-full h-full"
                title="Synnectify Technologies Location"
              ></iframe>
            </div>
